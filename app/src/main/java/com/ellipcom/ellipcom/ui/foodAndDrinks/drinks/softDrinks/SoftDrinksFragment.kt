package com.ellipcom.ellipcom.ui.foodAndDrinks.drinks.softDrinks
...
import com.ellipcom.ellipcom.databinding.FragmentSoftDrinksBinding
...
class SoftDrinksFragment : Fragment() {
    private var _binding: FragmentSoftDrinksBinding? = null
    ...
    private val productAdapter by lazy { SoftDrinksAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentSoftDrinksBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.softDrinksRV.layoutManager = GridLayoutManager(context, 2)
