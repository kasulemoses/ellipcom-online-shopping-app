package com.ellipcom.ellipcom.ui.medical.reproductiveHealth
...
import com.ellipcom.ellipcom.databinding.FragmentReproductiveHealthBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class ReproductiveHealthFragment : Fragment() {

    private var _binding: FragmentReproductiveHealthBinding? = null
    ...
    private val productAdapter by lazy { ReproductiveHealthAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentReproductiveHealthBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.reproductiveHealthRV.layoutManager = GridLayoutManager(context, 2)
