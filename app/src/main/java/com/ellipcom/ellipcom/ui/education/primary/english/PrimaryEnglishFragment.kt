package com.ellipcom.ellipcom.ui.education.primary.english
...
import com.ellipcom.ellipcom.databinding.FragmentPrimaryEnglishBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class PrimaryEnglishFragment : Fragment() {

    private var _binding: FragmentPrimaryEnglishBinding? = null
    ...
    private val productAdapter by lazy { PrimaryEngAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentPrimaryEnglishBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.primaryEngRV.layoutManager = GridLayoutManager(context, 2)
