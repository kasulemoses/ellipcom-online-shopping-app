...
class EducServiceSubCategoryAdapter(
    ...
    RecyclerView.Adapter<EducServiceSubCategoryAdapter.ProductsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onCategoryClickListener.onEducServicesCategoryItemClick(position)
        }
