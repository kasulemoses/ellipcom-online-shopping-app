package com.ellipcom.ellipcom.ui.education.science.biology
...
import com.ellipcom.ellipcom.databinding.FragmentBiologyBinding
...
class BiologyFragment : Fragment() {
    ...
    private val productAdapter by lazy { BiologyAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.biologyRV.layoutManager = GridLayoutManager(context, 2)
