package com.ellipcom.ellipcom.ui.education.primary.math
...
import com.ellipcom.ellipcom.databinding.FragmentPrimaryMathBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class PrimaryMathFragment : Fragment() {
    private var _binding: FragmentPrimaryMathBinding? = null
    ...
    private val productAdapter by lazy { PrimaryMathAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentPrimaryMathBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.primaryMathRV.layoutManager = GridLayoutManager(context, 2)
