package com.ellipcom.ellipcom.ui.education.science.computerStudies
...
import com.ellipcom.ellipcom.databinding.FragmentComputerStudiesBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class ComputerStudiesFragment : Fragment() {

    private var _binding: FragmentComputerStudiesBinding? = null
    ...
    private val productAdapter by lazy { ComputerStudiesAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentComputerStudiesBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.computerStudiesRV.layoutManager = GridLayoutManager(context, 2)
