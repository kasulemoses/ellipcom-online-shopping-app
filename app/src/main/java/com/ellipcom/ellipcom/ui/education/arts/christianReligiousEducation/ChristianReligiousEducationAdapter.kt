...
class ChristianReligiousEducationAdapter : RecyclerView.Adapter<ChristianReligiousEducationAdapter.ProductsViewHolder>() {
    ...
    fun setData(newList: ArrayList<ProductInformationModel>) {
        val diffUtil = ChristianReligiousEducationDiffUtil(
            oldProductList,
            newList
        )
