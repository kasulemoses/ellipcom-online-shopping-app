package com.ellipcom.ellipcom.ui.education.arts.geography
...
import com.ellipcom.ellipcom.databinding.FragmentGeographyBinding
...
class GeographyFragment : Fragment() {
    ...
    private val productAdapter by lazy { GeographyAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.geographyRV.layoutManager = GridLayoutManager(context, 2)
