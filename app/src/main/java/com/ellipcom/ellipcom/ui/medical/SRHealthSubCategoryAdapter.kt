...
class SRHealthSubCategoryAdapter(
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onCategoryClickListener.onSRHCategoryItemClick(position)
        }
