...
class FurnitureSubCategoryAdapter(
    ...
    RecyclerView.Adapter<FurnitureSubCategoryAdapter.ProductsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onCategoryClickListener.onFurnitureCategoryItemClick(position)
        }
    }
