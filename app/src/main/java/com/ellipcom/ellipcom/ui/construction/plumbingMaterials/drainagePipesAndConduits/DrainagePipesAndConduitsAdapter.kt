...
class DrainagePipesAndConduitsAdapter : RecyclerView.Adapter<DrainagePipesAndConduitsAdapter.ProductsViewHolder>() {
    ...
    fun setData(newList: ArrayList<ProductInformationModel>) {
        val diffUtil = DrainagePipesAndConduitsDiffUtil(
            oldProductList,
            newList
        )
