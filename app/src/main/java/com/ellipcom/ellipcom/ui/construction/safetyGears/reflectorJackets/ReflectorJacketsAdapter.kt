package com.ellipcom.ellipcom.ui.construction.safetyGears.reflectorJackets
...
class ReflectorJacketsAdapter : RecyclerView.Adapter<ReflectorJacketsAdapter.ProductsViewHolder>() {
    ...
    fun setData(newList: ArrayList<ProductInformationModel>) {
        val diffUtil = ReflectorJacketsDiffUtil(
            oldProductList,
            newList
        )
