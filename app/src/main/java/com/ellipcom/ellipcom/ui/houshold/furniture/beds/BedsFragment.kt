package com.ellipcom.ellipcom.ui.houshold.furniture.beds
...
import com.ellipcom.ellipcom.databinding.FragmentBedsBinding
...
class BedsFragment : Fragment() {
    ...
    private val productAdapter by lazy { BedsAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.bedsRV.layoutManager = GridLayoutManager(context, 2)
        productList = ArrayList()
        binding.bedsRV.adapter = productAdapter
        attachingDataToRv()
