package com.ellipcom.ellipcom.ui.houshold.furniture.chairs
...
import com.ellipcom.ellipcom.databinding.FragmentChairsBinding
...
class ChairsFragment : Fragment() {
    ...
    private var _binding: FragmentChairsBinding? = null
    ...
    private val productAdapter by lazy { ChairsAdapter() }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChairsBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.chairsRV.layoutManager = GridLayoutManager(context, 2)
        productList = ArrayList()
        binding.chairsRV.adapter = productAdapter
        attachingDataToRv()
