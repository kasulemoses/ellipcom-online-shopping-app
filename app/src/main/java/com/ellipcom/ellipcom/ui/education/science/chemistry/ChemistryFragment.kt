package com.ellipcom.ellipcom.ui.education.science.chemistry
...
import com.ellipcom.ellipcom.databinding.FragmentChemistryBinding
...
class ChemistryFragment : Fragment() {
    ...
    private val productAdapter by lazy { ChemistryAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.chemistryRV.layoutManager = GridLayoutManager(context, 2)
