package com.ellipcom.ellipcom.ui.education.science.agriculture
...
import com.ellipcom.ellipcom.databinding.FragmentAgricultureBinding
...
class AgricultureFragment : Fragment() {
    ...
    private var _binding: FragmentAgricultureBinding? = null
    ...
    private val productAdapter by lazy { AgricultureAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentAgricultureBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.agricultureRV.layoutManager = GridLayoutManager(context, 2)
