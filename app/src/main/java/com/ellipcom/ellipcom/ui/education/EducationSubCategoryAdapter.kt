...
class EducationSubCategoryAdapter(private var oldProductList:ArrayList<CategoryModel>) :
    RecyclerView.Adapter<EducationSubCategoryAdapter.ProductsViewHolder>() {
