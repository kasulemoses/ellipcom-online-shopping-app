package com.ellipcom.ellipcom.ui.houshold.furniture.sofas
...
import com.ellipcom.ellipcom.databinding.FragmentSofasBinding
...
class SofasFragment : Fragment() {
    ...
    private var _binding: FragmentSofasBinding? = null
    ...
    private val productAdapter by lazy { SofasAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentSofasBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.sofasRV.layoutManager = GridLayoutManager(context, 2)
        productList = ArrayList()
        binding.sofasRV.adapter = productAdapter
        attachingDataToRv()
