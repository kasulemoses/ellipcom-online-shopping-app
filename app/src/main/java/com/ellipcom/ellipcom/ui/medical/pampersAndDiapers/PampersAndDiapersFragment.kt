package com.ellipcom.ellipcom.ui.medical.pampersAndDiapers
...
import com.ellipcom.ellipcom.databinding.FragmentPampersAndDiapersBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore

class PampersAndDiapersFragment : Fragment() {
    private var _binding: FragmentPampersAndDiapersBinding? = null
    ...
    private val productAdapter by lazy { PampersAndDiapersAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentPampersAndDiapersBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.pampersAndDiapersRV.layoutManager = GridLayoutManager(context, 2)
