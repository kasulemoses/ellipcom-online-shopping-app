package com.ellipcom.ellipcom.ui.foodAndDrinks.food.sugar
...
import com.ellipcom.ellipcom.databinding.FragmentSugarBinding
...
class SugarFragment : Fragment() {
    ...
    private val productAdapter by lazy { SugarAdapter() }
    override fun onCreateView(
        ...
        binding.sugarRV.layoutManager = GridLayoutManager(context, 2)
