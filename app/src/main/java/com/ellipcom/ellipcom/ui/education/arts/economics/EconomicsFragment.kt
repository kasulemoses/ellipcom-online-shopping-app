package com.ellipcom.ellipcom.ui.education.arts.economics
...
import com.ellipcom.ellipcom.databinding.FragmentEconomicsBinding
...
class EconomicsFragment : Fragment() {
    ...
    private var _binding: FragmentEconomicsBinding? = null
    ...
    private val productAdapter by lazy { EconomicsAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentEconomicsBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.economicRV.layoutManager = GridLayoutManager(context, 2)
