package com.ellipcom.ellipcom.ui.education.arts.history
...
class HistoryFragment : Fragment() {
    ...
    private val productAdapter by lazy { HistoryAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.historyRV.layoutManager = GridLayoutManager(context, 2)
