package com.ellipcom.ellipcom.ui.construction.plumbingMaterials.showers
...
import com.ellipcom.ellipcom.databinding.FragmentShowersBinding
...
class ShowersFragment : Fragment() {
    ...
    private val productAdapter by lazy { ShowersAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.showersRV.layoutManager = GridLayoutManager(context, 2)
        productList = ArrayList()
        binding.showersRV.adapter = productAdapter
        attachingDataToRv()
