package com.ellipcom.ellipcom.ui.medical.painKillers
...
import com.ellipcom.ellipcom.databinding.FragmentPainKillersBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class PainKillersFragment : Fragment() {

    private var _binding: FragmentPainKillersBinding? = null
    ...
    private val productAdapter by lazy { PainKillersAdapter() }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPainKillersBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.painKillersRV.layoutManager = GridLayoutManager(context, 2)
