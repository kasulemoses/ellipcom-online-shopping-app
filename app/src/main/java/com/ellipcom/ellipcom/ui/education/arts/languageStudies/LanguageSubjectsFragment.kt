package com.ellipcom.ellipcom.ui.education.arts.languageStudies
...
import com.ellipcom.ellipcom.databinding.FragmentLanguageSubjectsBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore

class LanguageSubjectsFragment : Fragment() {

    private var _binding: FragmentLanguageSubjectsBinding? = null
    ...
    private val productAdapter by lazy { LanguageStudiesAdapter() }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLanguageSubjectsBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.languagesStudiesRV.layoutManager = GridLayoutManager(context, 2)
