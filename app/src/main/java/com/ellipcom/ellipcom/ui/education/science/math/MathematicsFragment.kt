package com.ellipcom.ellipcom.ui.education.science.math
...
import com.ellipcom.ellipcom.databinding.FragmentMathematicsBinding
...
class MathematicsFragment : Fragment() {
    ...
    private val productAdapter by lazy { MathAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.mathematicsRV.layoutManager = GridLayoutManager(context, 2)
