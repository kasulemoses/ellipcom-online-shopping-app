package com.ellipcom.ellipcom.ui.education.primary.sst
...
import com.ellipcom.ellipcom.databinding.FragmentPrimarySstBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class PrimarySstFragment : Fragment() {

    private var _binding: FragmentPrimarySstBinding? = null
    ...
    private val productAdapter by lazy { SstAdapter() }
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentPrimarySstBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.primarySstRV.layoutManager = GridLayoutManager(context, 2)
