package com.ellipcom.ellipcom.ui.construction.plumbingMaterials.tiles
...
import com.ellipcom.ellipcom.databinding.FragmentTilesBinding
...
class TilesFragment : Fragment() {
    ...
    private val productAdapter by lazy { TilesAdapter() }
    ...
    override fun onCreateView(
        ...
        binding.tilesRV.layoutManager = GridLayoutManager(context, 2)
        productList = ArrayList()
        binding.tilesRV.adapter = productAdapter
        attachingDataToRv()
