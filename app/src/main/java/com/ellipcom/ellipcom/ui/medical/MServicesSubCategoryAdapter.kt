...
class MServicesSubCategoryAdapter(
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onCategoryClickListener.onMServicesCategoryItemClick(position)
        }
