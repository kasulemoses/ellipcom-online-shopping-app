package com.ellipcom.ellipcom.ui.foodAndDrinks.food.flour
...
import com.ellipcom.ellipcom.databinding.FragmentFlourBinding
import com.ellipcom.ellipcom.model.ProductInformationModel
import com.google.firebase.firestore.DocumentChange
import com.google.firebase.firestore.FirebaseFirestore


class FlourFragment : Fragment() {
    private var _binding: FragmentFlourBinding? = null
    ...
    private val productAdapter by lazy { FlourAdapter() }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentFlourBinding.inflate(inflater, container, false)


        fireDb = FirebaseFirestore.getInstance()

        binding.flourRV.layoutManager = GridLayoutManager(context, 2)
