...
class PrimarySubCategoryAdapter(
    ...
    RecyclerView.Adapter<PrimarySubCategoryAdapter.ProductsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onCategoryClickListener.onPrimaryCategoryItemClick(position)
        }
